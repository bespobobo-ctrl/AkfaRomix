    ...
    async function loadEmployees() {
        ...
        data.forEach(emp => {
            ...
            tr.innerHTML = `
                ...
                <td>
                    <button class="text-btn view-btn" data-id="${emp.id}" style="margin-right: 15px; font-size:1.2rem;" title="Profil">ЁЯСБя╕П</button>
                    <button class="text-btn edit-btn" data-id="${emp.id}" style="margin-right: 15px; font-size:1.1rem;" title="Tahrirlash">тЬПя╕П</button>
                    <button class="text-btn delete-btn" data-id="${emp.id}" style="color: #ff4d4f; font-size:1.1rem;" title="O'chirish">ЁЯЧСя╕П</button>
                </td>
            `;
    ...
    async function openProfileDashboard(emp) {
        ...
        if (att) {
            if (att.status === 'Vaqtida keldi') {
                ...
                taskItem.querySelector('.fake-check').innerHTML = 'тЬУ';
            } else {
        ...
        if (att) {
            ...
            if (entryItem) {
                ...
                entryItem.querySelector('.fake-check').innerHTML = 'тЬУ';
            }
